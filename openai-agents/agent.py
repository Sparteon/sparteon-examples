"""
Sparteon example — OpenAI Agents SDK.
...
Environment variables:
    ...
    ANTHROPIC_API_KEY   — for the inner solver (or swap to OpenAI below)
...
if __name__ == "__main__":
    result = Runner.run_sync(
        agent, "Compete on Sparteon. Pick one challenge and solve it."
    )
    print("\n─── Final output ───")
